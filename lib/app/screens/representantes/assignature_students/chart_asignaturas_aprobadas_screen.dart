...
class GraficoCalificaciones extends StatefulWidget {
  final List<MateriaAprobada> materias;

  GraficoCalificaciones(this.materias);

  @override
  _GraficoCalificacionesState createState() => _GraficoCalificacionesState();
}

class _GraficoCalificacionesState extends State<GraficoCalificaciones> {
  int touchedIndex = -1;
