...
import 'package:capacidades_especiales/app/widgets/estudiantes/puzzle/level_puzzle_widget.dart';
...
class _PainterScreenState extends State<RompeCabezasScreen> {
              ...
              Navigator.push(
                ...
                MaterialPageRoute(
                  builder: (context) => LevelSelectionPage(
                    ...
                    imageUrl,
                    // Nivel del juego, ajusta según tus necesidades
                  ),
                ),
              );
            },
