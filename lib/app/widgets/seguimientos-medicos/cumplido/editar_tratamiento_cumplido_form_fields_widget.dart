...
class EditarTratamientoCumplidoFormFields extends StatefulWidget {
  ...
  const EditarTratamientoCumplidoFormFields({
    Key? key,
  ...
  @override
  _EditarTratamientoCumplidoFormFieldsState createState() =>
      _EditarTratamientoCumplidoFormFieldsState();
}

class _EditarTratamientoCumplidoFormFieldsState
    extends State<EditarTratamientoCumplidoFormFields> {
              ...
              children: [
                Switch(
                  ...
                  onChanged: (bool value) {
                    setState(() {
                      _cumplimiento = value;
                      widget.onCumplimientoChanged(
                          value); // Notificar al callback
                    });
                  },
                ),
                Text(_cumplimiento
                    ? 'Sí'
                    : 'No'), // Mostrar "Sí" o "No" según el estado del switch
              ],
            ),
          ],
        ),
